...
int main() {
    ...
    // printf("B的子矩阵的各个列向量:\n");
    // print_vector(B00_cols[0], rows/2);
    // print_vector(B00_cols[1], rows/2);
    // print_vector(B00_cols[2], rows/2);
    // print_vector(B00_cols[3], rows/2);
    // print_vector(B01_cols[0], rows/2);
    // print_vector(B01_cols[1], rows/2);
    // print_vector(B01_cols[2], rows/2);
    // print_vector(B01_cols[3], rows/2);
    // print_vector(B10_cols[0], rows/2);
    // print_vector(B10_cols[1], rows/2);
    // print_vector(B10_cols[2], rows/2);
    // print_vector(B10_cols[3], rows/2);
    // print_vector(B11_cols[0], rows/2);
    // print_vector(B11_cols[1], rows/2);
    // print_vector(B11_cols[2], rows/2);
    // print_vector(B11_cols[3], rows/2);
    ...
    #pragma omp parallel
    {
        ...
        //for (int i = 0; i < 15; i++) {
            if (thread_id == 0) {
                ...
                //printf("outc_0_0:\n");
                //print_vector(outc_0_0, rows/2);
                //在tile0上计算outc_0_1
                setup_array(matA01, B10_cols[0], 0);
                execute_mvm(0);
                store_vector(outc_0_1, 0);
                //printf("outc_0_1:\n");
                //print_vector(outc_0_1, rows/2);
            ...
            if (thread_id == 1) {
                ...
                //printf("outc_1_0:\n");
                //print_vector(outc_1_0, rows/2);
                setup_array(matA01, B10_cols[1], 0);
                execute_mvm(0);
                store_vector(outc_1_1, 0);
                //printf("outc_1_1:\n");
                //print_vector(outc_1_1, rows/2);
                for (int i = 0; i < cols/2; i++) {
