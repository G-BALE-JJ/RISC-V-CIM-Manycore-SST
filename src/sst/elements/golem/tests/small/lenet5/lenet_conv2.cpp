...
int main(int argc, char* argv[]) {
    ...
    golem_matmul_op_desc_t op_desc = {
        .m = read_i64_env_or_default("GOLEM_MATMUL_M", 256),
        .n = read_i64_env_or_default("GOLEM_MATMUL_N", 16),
        .k = read_i64_env_or_default("GOLEM_MATMUL_K", 192),
        .block_m = read_i64_env_or_default("GOLEM_MATMUL_BLOCK_M", TILE_DIM),
        .block_n = read_i64_env_or_default("GOLEM_MATMUL_BLOCK_N", 16),
    ...
    return conv2_ops::run_conv2(core_id, op_desc, dtype);
}
