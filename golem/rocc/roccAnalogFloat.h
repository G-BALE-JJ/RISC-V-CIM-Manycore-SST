...
#ifndef _H_ANALOG_ROCC_FLOAT
#define _H_ANALOG_ROCC_FLOAT
...
class RoCCAnalogFloat : public RoCCAnalog<float> {
public:
    SST_ELI_REGISTER_SUBCOMPONENT(
        ...
        "Implements a RoCC accelerator interface for the analog core (float version)",
        SST::Golem::RoCCAnalog<float>
    )
    ...
    RoCCAnalogFloat(ComponentId_t id, Params &params)
        : RoCCAnalog<float>(id, params) {}
};
